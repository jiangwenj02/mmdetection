...
python tools/eval_others.py --result work_dirs/faster_rcnn_r50_fpn_1x_erosive_9x/result.bbox.json --ann /data0/zzhang/annotation/erosive/test.json --num_clsses 1
